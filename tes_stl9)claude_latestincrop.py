...
class CleanLingualWireGenerator:
    ...
    def create_clean_visualization_meshes(self):
        ...
        # Create bracket markers - only for blue brackets
        bracket_markers = o3d.geometry.TriangleMesh()
        
        for bracket in blue_brackets:
            # Create bracket box
        ...
        print(f"✓ Wire segments only between blue brackets")
    ...
    def visualize_clean_system(self, components):
        ...
        print("\nCLEAN DISPLAY:")
        print("  • BLUE brackets: Only remaining posterior teeth")
        print("  • GOLD wire: Only segments connecting blue brackets")
